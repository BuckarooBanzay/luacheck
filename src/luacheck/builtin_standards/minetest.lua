...
local minetest = {
    fields = {
        ...
        registered_on_mods_loadeds = open_table,
        registered_on_shutdowns = open_table,
        ...
        registered_on_player_hpchanges = open_table,
        ...
        registered_on_protection_violations = open_table,
        registered_on_item_eats = open_table,
        registered_on_item_pickups = open_table,
        registered_on_priv_grants = open_table,
        registered_on_priv_revokes = open_table,
        registered_can_bypass_userlimits = open_table,
        registered_on_modchannel_messages = open_table,
        registered_on_liquid_transformeds = open_table,
        registered_on_mapblocks_changeds = open_table,
